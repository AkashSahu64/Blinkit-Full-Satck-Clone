    ...
    <section>
      ...
      <div className="grid p-3">
        <form className="grid gap-3" onSubmit={handleSubmit}>
                ...
                {data.image.map((img, index) => {
                  return (
                    ...
                    >
                      ...
                      />
                      <div className="absolute top-0 right-0 bg-red-100 p-1 rounded-full cursor-pointer hover:bg-red-200 hover:text-red-500 hidden group-hover:block" onClick={()=>handleDeleteImage(index)}>
                        <MdDelete/>
                      </div>
                    </div>
                  );
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
              {
                data.category.map((cat, index) => {
                  return (
                    <div key={index} className="flex items-center gap-1 bg-blue-50 mt-2">
                      <p>{cat.name}</p>
          ...
          <div className="bg-white hover:bg-primary-200 py-1 px-3 w-32 text-center font-semibold border border-primary-200 rounded cursor-pointer transition-all duration-200 text-primary-200 hover:text-white"

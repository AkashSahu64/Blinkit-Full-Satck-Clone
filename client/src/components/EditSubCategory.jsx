        ...
        <form className="my-3 grid gap-3" onSubmit={handleSubmitSubCategory}>
          ...
          <button>
            <div className={`px-4 py-2 border
              ${subCategoryData?.name && subCategoryData?.image && subCategoryData?.category[0] ? "bg-primary-200 hover:bg-primary-100 text-neutral-900" : "bg-neutral-200 text-neutral-400"}
